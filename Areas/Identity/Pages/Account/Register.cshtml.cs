...
namespace EpicBookstoreSprint.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    UserName = Input.Email, // Set the UserName to the user's emai
                ...
                // Ensure the Address property is not null or empty
                if (string.IsNullOrWhiteSpace(User.Address))
                {
                    ModelState.AddModelError(nameof(Input.Address), "Address cannot be empty.");
                    return Page();
                }
                ...
                // Use the newly created User instance instead of the original user
